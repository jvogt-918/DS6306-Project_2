...
## This bar plot displays the count of crabs for each sex category (`F`, `M`, and `I`) in the dataset. It provides a straightforward visual summary of the distribution of the categorical variable `Sex`, which is essential for understanding the dataset’s composition before conducting further analysis. This type of plot is a core part of univariate analysis when dealing with categorical variables, as it allows us to observe how frequently each category appears in the dataset.
...
## Scatter plots of each feature against Age
